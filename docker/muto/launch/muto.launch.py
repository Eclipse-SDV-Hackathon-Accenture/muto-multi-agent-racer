...
agent_pkg_name = "agent"
composer_pkg_name = "composer"
output = "screen"

def generate_launch_description():

    # Files
    agent_config = os.path.join(get_package_share_directory(agent_pkg_name), "config", "agent.yaml")
    composer_config = os.path.join(get_package_share_directory(composer_pkg_name), "config", "composer.yaml")
    core_config = os.path.join(get_package_share_directory("core"), "config", "core.yaml")
